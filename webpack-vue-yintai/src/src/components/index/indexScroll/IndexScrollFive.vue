  ...
  <div class="Nav_title" v-if="pdArr != null">
    ...
    <div class="title_top">
      ...
      <img class="tagimg" :src="goods.items[0].imgurl" alt="" v-for="goods in pdArr"
           v-if="goods.templatename === '头图'||goods.templatename === '头图1'||goods.templatename === '头图2'"
           :key="goods.templateid">
      <img class="tagimg" :src="goods.items[0].imgurl" alt="" v-for="goods in pdArr"
           v-if="goods.templatename === '导语'||goods.templatename === '单品推荐'"
           :key="goods.templateid">
    </div>
    ...
    <div class="pd_content">
      ...
      <div class="active">
        ...
        <div class="activity1" v-for="">
          <img class="tagimg" :src="goods.items[0].imgurl" alt="" v-for="goods in pdArr"
               v-if="goods.templatename === '品牌精选'"
               :key="goods.templateid">
          <div class="act_goods" v-for="aaa in pdArr"
               v-if="aaa.templatename === '品牌'||aaa.templatename === '品牌1'||aaa.templatename === '品牌2'||aaa.templatename === '品牌3'||aaa.templatename === '品牌4'">
            <img :src="bbb.imgurl" alt="" v-for="bbb in aaa.items">
          </div>
        </div>
      </div>
      ...
      <!--单品区-->
      <img class="tagimg" :src="goods.items[0].imgurl" alt="" v-for="goods in pdArr"
           v-if="goods.templatename === '列表'&&  goods.templateid === 20024063"
           :key="goods.templateid">
      <div class="pd_goodsShow">
        <div class="goods_wrap">
          <div class="pd_goods" v-for="goods in pdArr" :key="goods.templateid"
               v-if="goods.templatename === '列表'&& goods.templateid === 20024067">
...
<script>
  export default {
    ...
    mounted () {
      this.$request({
        type: 'get',
        url: 'api?r=201711271713&os=HTML5&client_v=1.0.0&pageid=30002290&previewtime=0&methodName=products.template.getpage_1.0.0&method=products.template.getpage&apptype=10&ver=1.0.0&pageindex=1',
        headers: {},
        params: {},
